...
# plots to compare
plotCHLP <- fviz_cluster(k_CHLP, geom = "point", data = clust_data_CHLP, choose.vars = c("posWords", "sentScore")) + ggtitle("CHLP")
plotUSSPKP <- fviz_cluster(k_USSPKP, geom = "point", data = clust_data_USSPKP, choose.vars = c("posWords", "sentScore")) + ggtitle("USSPKP")
plotCHMPPPPV <- fviz_cluster(k_CHMPPPPV, geom = "point", data = clust_data_CHMPPPPV, choose.vars = c("posWords", "sentScore")) + ggtitle("CHMPPPPV")
plotEBTCE <- fviz_cluster(k_EBTCE, geom = "point", data = clust_data_EBTCE, choose.vars = c("posWords", "sentScore")) + ggtitle("EBTCE")
plotSLC <- fviz_cluster(k_SLC, geom = "point", data = clust_data_SLC, choose.vars = c("posWords", "sentScore")) + ggtitle("SLC")
plotDCCAS <- fviz_cluster(k_DCCAS, geom = "point", data = clust_data_DCCAS, choose.vars = c("posWords", "sentScore")) + ggtitle("DCCAS")
